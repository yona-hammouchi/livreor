...
<body>
    ...
    <main>
        <section class="homepage">
            <img src="./assets/revel.jpg" alt="reveal_img" width="60%">
        ...
        <section class="container_button_book">
            <p>Voici notre
                <a href="../pages/livre-or.php">
                    <button>Livre d'or</button>
                </a>
                où vous pouvez nous laisser un petit message.
            </p>
        </section>
